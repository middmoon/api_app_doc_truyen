(() => {
    ...
    unpack_string(e) {
      ...
      for (; i < e; )
        (t = r[i]) < 160
          ...
          : (224 ^ t) < 16
          ? ((n = ((15 & t) << 12) | ((63 & r[i + 1]) << 6) | (63 & r[i + 2])), (i += 3))
          : ((n = ((7 & t) << 18) | ((63 & r[i + 1]) << 12) | ((63 & r[i + 2]) << 6) | (63 & r[i + 3])), (i += 4)),
  ...
  class a {
    ...
    pack_integer(e) {
      ...
      else if (e >= -0x8000000000000000 && e <= 0x7fffffffffffffff) this._bufferBuilder.append(211), this.pack_int64(e);
  ...
  function h(e) {
    return "boolean" != typeof e
      ...
      : ((c = e), e ? "adapter.js logging disabled" : "adapter.js logging enabled");
  }
  function u(e) {
    return "boolean" != typeof e
      ? Error("Argument type: " + typeof e + ". Please use a boolean.")
          ...
          Object.keys(e).forEach((n) => {
            ...
            if (void 0 !== r.ideal) {
              ...
              "number" == typeof r.ideal
                ? ((e[i("min", n)] = r.ideal), t.optional.push(e), ((e = {})[i("max", n)] = r.ideal))
                : (e[i("", n)] = r.ideal),
                t.optional.push(e);
            }
      ...
      i = function (e, i) {
        ...
        if (e && "object" == typeof e.video) {
          ...
          if (
            ...
            !(n.mediaDevices.getSupportedConstraints && n.mediaDevices.getSupportedConstraints().facingMode && !s)
          ) {
            let t;
            if (
              ...
              return n.mediaDevices.enumerateDevices().then((n) => {
                ...
                return (
                  ...
                  s && (e.video.deviceId = o.exact ? { exact: s.deviceId } : { ideal: s.deviceId }),
                  (e.video = r(e.video)),
    ...
    if ((!e.navigator.mediaDevices || !("getDisplayMedia" in e.navigator.mediaDevices)) && e.navigator.mediaDevices) {
      ...
      e.navigator.mediaDevices.getDisplayMedia = function (n) {
        return t(n).then((t) => {
          ...
          return (
            (n.video = { mandatory: { chromeMediaSource: "desktop", chromeMediaSourceId: t, maxFrameRate: o || 3 } }),
  ...
  function F(e) {
    if ("object" != typeof e || !e.RTCPeerConnection || "ontrack" in e.RTCPeerConnection.prototype)
      d(e, "track", (e) => (e.transceiver || Object.defineProperty(e, "transceiver", { value: { receiver: e.receiver } }), e));
    else {
  ...
  function N(e) {
    ...
    e.RTCPeerConnection.prototype.getStats = function () {
      if (arguments.length > 0 && arguments[0] instanceof e.MediaStreamTrack) {
        ...
        this.getReceivers().forEach((e) => (e.track === r && (t ? (n = !0) : (t = e)), e.track === r)),
        n || (e && t))
    ...
    e.RTCPeerConnection.prototype.addTrack = function (e, n) {
      ...
      return (
        this._shimmedLocalStreams[n.id]
          ? -1 === this._shimmedLocalStreams[n.id].indexOf(r) && this._shimmedLocalStreams[n.id].push(r)
    ...
    Object.defineProperty(e.RTCPeerConnection.prototype, "localDescription", {
      ...
      (e.RTCPeerConnection.prototype.removeTrack = function (e) {
        ...
        (this._streams = this._streams || {}),
          ...
          t &&
            (1 === t.getTracks().length ? this.removeStream(this._reverseStreams[t.id]) : t.removeTrack(e.track),
            this.dispatchEvent(new Event("negotiationneeded")));
      });
  }
  function V(e, t) {
      ...
      e.RTCPeerConnection &&
        ...
        ["setLocalDescription", "setRemoteDescription", "addIceCandidate"].forEach(function (t) {
          ...
          e.RTCPeerConnection.prototype[t] = {
            [t]() {
              return (
                (arguments[0] = new ("addIceCandidate" === t ? e.RTCIceCandidate : e.RTCSessionDescription)(arguments[0])), n.apply(this, arguments)
              );
            },
          }[t];
        });
        ...
        ((n.mediaDevices.getUserMedia = function (n) {
          return (
            "object" == typeof n &&
              ...
              (e((n = JSON.parse(JSON.stringify(n))).audio, "autoGainControl", "mozAutoGainControl"),
      ...
      if (r && r.prototype.applyConstraints) {
        ...
        r.prototype.applyConstraints = function (n) {
          return (
            "audio" === this.kind &&
              "object" == typeof n &&
              (e((n = JSON.parse(JSON.stringify(n))), "autoGainControl", "mozAutoGainControl"), e(n, "noiseSuppression", "mozNoiseSuppression")),
            t.apply(this, [n])
          );
        };
      }
    ...
    t &&
      (e.RTCPeerConnection.prototype.addTransceiver = function () {
        ...
        if (n) {
          let { sender: t } = r,
            n = t.getParameters();
          ("encodings" in n && (1 !== n.encodings.length || 0 !== Object.keys(n.encodings[0]).length)) ||
            ((n.encodings = e),
            (t.sendEncodings = e),
    ...
    (e.RTCPeerConnection = function (e, n) {
      if (e && e.iceServers) {
        ...
        for (let n = 0; n < e.iceServers.length; n++) {
          ...
          void 0 === r.urls && r.url
            ? (m("RTCIceServer.url", "RTCIceServer.urls"), ((r = JSON.parse(JSON.stringify(r))).urls = r.url), delete r.url, t.push(r))
      ...
      "generateCertificate" in t && Object.defineProperty(e.RTCPeerConnection, "generateCertificate", { get: () => t.generateCertificate });
  }
  function eh(e) {
    "object" == typeof e &&
      e.RTCTrackEvent &&
      ...
      if (e) {
        ...
        !1 === e.offerToReceiveAudio && t
          ? "sendrecv" === t.direction
            ...
            : "recvonly" === t.direction && (t.setDirection ? t.setDirection("inactive") : (t.direction = "inactive"))
          : !0 !== e.offerToReceiveAudio || t || this.addTransceiver("audio", { direction: "recvonly" }),
        ...
        !1 === e.offerToReceiveVideo && n
          ...
          : !0 !== e.offerToReceiveVideo || n || this.addTransceiver("video", { direction: "recvonly" });
      }
      return t.apply(this, arguments);
    };
  }
    ...
    (e.RTCIceCandidate = function (e) {
      if (
        ("object" == typeof e &&
          ...
          ((e = JSON.parse(JSON.stringify(e))).candidate = e.candidate.substring(2)),
      ...
      d(
        e,
        "icecandidate",
        (t) => (t.candidate && Object.defineProperty(t, "candidate", { value: new e.RTCIceCandidate(t.candidate), writable: "false" }), t)
      );
  }
  function eC(e) {
    !e.RTCIceCandidate ||
      ...
      d(e, "icecandidate", (e) => {
        if (e.candidate) {
          ...
          "relay" === n.type && (e.candidate.relayProtocol = { 0: "tls", 1: "tcp", 2: "udp" }[n.priority >> 24]);
        }
        return e;
      });
  }
  function ev(e, n) {
    ...
    e.RTCPeerConnection.prototype.setRemoteDescription = function () {
      ...
      if (r(arguments[0])) {
        ...
        let a = {};
        Object.defineProperty(a, "maxMessageSize", { get: () => e }), (this._sctp = a);
      }
      ...
      Object.defineProperty(t, "onconnectionstatechange", {
        ...
        set(e) {
          this._onconnectionstatechange &&
            (this.removeEventListener("connectionstatechange", this._onconnectionstatechange), delete this._onconnectionstatechange),
  ...
  function eT(e, t) {
    ...
    n &&
      ...
      (e.RTCPeerConnection.prototype.addIceCandidate = function () {
        return arguments[0]
          ? (("chrome" === t.browser && t.version < 78) || ("firefox" === t.browser && t.version < 68) || "safari" === t.browser) &&
            arguments[0] &&
    ...
    n &&
      ...
      (e.RTCPeerConnection.prototype.setLocalDescription = function () {
        ...
        return e.sdp || ("offer" !== e.type && "answer" !== e.type)
          ? n.apply(this, [e])
          : ("offer" === e.type ? this.createOffer : this.createAnswer).apply(this).then((e) => n.apply(this, [e]));
      });
  }
  (ey.generateIdentifier = function () {
    ...
    (ey.getDtlsParameters = function (e, t) {
      return { role: "auto", fingerprints: ey.matchPrefix(e + t, "a=fingerprint:").map(ey.parseFingerprint) };
    }),
    ...
    (ey.writeCryptoLine = function (e) {
      return (
        ...
        e.cryptoSuite +
        " " +
        ("object" == typeof e.keyParams ? ey.writeCryptoKeyParams(e.keyParams) : e.keyParams) +
    ...
    (ey.writeCryptoKeyParams = function (e) {
      return (
        e.keyMethod + ":" + e.keySalt + (e.lifeTime ? "|" + e.lifeTime : "") + (e.mkiValue && e.mkiLength ? "|" + e.mkiValue + ":" + e.mkiLength : "")
      );
    }),
    ...
    (ey.getIceParameters = function (e, t) {
      ...
      return n && r ? { usernameFragment: n.substring(12), password: r.substring(10) } : null;
    }),
    ...
    (ey.writeRtpDescription = function (e, t) {
      ...
      (n +=
        ...
        " " +
        t.codecs.map((e) => (void 0 !== e.preferredPayloadType ? e.preferredPayloadType : e.payloadType)).join(" ") +
      ...
      c.length > 0 && c[0].length > 1 && c[0][0] === a && (t = c[0][1]),
        r.codecs.forEach((e) => {
          if ("RTX" === e.name.toUpperCase() && e.parameters.apt) {
            let r = { ssrc: a, codecPayloadType: parseInt(e.parameters.apt, 10) };
            a && t && (r.rtx = { ssrc: t }),
              n.push(r),
              i && (((r = JSON.parse(JSON.stringify(r))).fec = { ssrc: a, mechanism: o ? "red+ulpfec" : "red" }), n.push(r));
          }
        }),
    ...
    (ey.parseMsid = function (e) {
      ...
      if (1 === n.length) return { stream: (t = n[0].substring(7).split(" "))[0], track: t[1] };
      let r = ey
        .matchPrefix(e, "a=ssrc:")
        .map((e) => ey.parseSsrcMedia(e))
    ...
    (ey.parseSctpDescription = function (e) {
      ...
      if (i.length > 0) return { port: parseInt(i[0].substring(12), 10), protocol: n.fmt, maxMessageSize: t };
    ...
    (eg = ey);
  let ew = (function ({ window: e } = {}, t = { shimChrome: !0, shimFirefox: !0, shimSafari: !0 }) {
      let n = (function (e) {
          ...
          return (
            n.mozGetUserMedia
              ...
              : n.webkitGetUserMedia || (!1 === e.isSecureContext && e.webkitRTCPeerConnection)
        ...
        r = { browserDetails: n, commonShim: em, extractVersion: p, disableLog: h, disableWarnings: u, sdp: eg };
      switch (n.browser) {
        case "chrome":
      ...
      constructor(...e) {
        super(...e),
          ...
          (this.supports = (function () {
            let e;
            let t = { browser: eE.isBrowserSupported(), webRTC: eE.isWebRTCSupported(), audioVideo: !1, data: !1, binaryBlob: !1, reliable: !1 };
            if (!t.webRTC) return t;
            try {
              let n;
              (e = new RTCPeerConnection(eI)), (t.audioVideo = !0);
              try {
                (n = e.createDataChannel("_PEERJSTEST", { ordered: !0 })), (t.data = !0), (t.reliable = !!n.ordered);
                try {
  ...
  Object.create && ((eB.prototype = Object.create(null)), new eB().__proto__ || (eA = !1)),
  ...
  class eV {
      ...
      eO.log("Listening for ICE candidates."),
        (e.onicecandidate = (e) => {
          e.candidate &&
            ...
            i.socket.send({ type: O.Candidate, payload: { candidate: e.candidate, type: r, connectionId: n }, dst: t }));
        }),
      ...
      try {
        ...
        try {
          ...
          if (this.connection.type === P.Data) {
            ...
            r = { ...r, label: e.label, reliable: e.reliable, serialization: e.serialization };
          }
          t.socket.send({ type: O.Offer, payload: r, dst: this.connection.peer });
        } catch (e) {
          "OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer" != e &&
      ...
      try {
        ...
        try {
          await e.setLocalDescription(n),
            ...
            t.socket.send({
              type: O.Answer,
              payload: { sdp: n, type: this.connection.type, connectionId: this.connection.connectionId },
    ...
    _addTracksToConnection(e, t) {
      if ((eO.log(`add tracks from stream ${e.id} to peer connection`), !t.addTrack))
  ...
  class eY extends eH {
    ...
    answer(e, t = {}) {
      ...
      this._negotiator.startConnection({ ...this.options._payload, _stream: e }),
    ...
    constructor(e, t, n) {
      super(e, t, n),
        ...
        this._localStream && this._negotiator.startConnection({ _stream: this._localStream, originator: !0 });
    }
  }
  eY.ID_PREFIX = "mc_";
  class eK {
      ...
      try {
        ...
        throw (
          ("/" === this._options.path &&
            ...
            (e = " If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."),
  ...
  class eX extends eH {
    ...
    close(e) {
      ...
      this._negotiator && (this._negotiator.cleanup(), (this._negotiator = null)),
        this.provider && (this.provider._removeConnection(this), (this.provider = null)),
        this.dataChannel &&
          ((this.dataChannel.onopen = null), (this.dataChannel.onmessage = null), (this.dataChannel.onclose = null), (this.dataChannel = null)),
        this.open && ((this._open = !1), super.emit("close"));
    }
    send(e, t = !1) {
      if (!this.open) {
    ...
    constructor(e, t, n) {
      super(e, t, n),
        ...
        (this._negotiator = new eV(this)),
        this._negotiator.startConnection(this.options._payload || { originator: !0, reliable: this.reliable });
    }
  }
  ...
  class e1 extends eG {
      ...
      switch (t) {
        ...
        case O.Offer: {
          ...
          if ((t && (t.close(), eO.warn(`Offer received for existing Connection ID:${e}`)), n.type === P.Media)) {
            let i = new eY(r, this, { connectionId: e, _payload: n, metadata: n.metadata });
    ...
    reconnect() {
      if (this.disconnected && !this.destroyed)
        eO.log(`Attempting reconnection to server with ID ${this._lastServerId}`), (this._disconnected = !1), this._initialize(this._lastServerId);
    ...
    constructor(e, t) {
      ...
      if (
        (super(),
        (this._serializers = { raw: eZ, json: e0, binary: eQ, "binary-utf8": eQ, default: eQ }),
        (this._id = null),
        ...
        this._options.path &&
          ("/" !== this._options.path[0] && (this._options.path = "/" + this._options.path),
  ...
  (e1.DEFAULT_KEY = "peerjs"), (window.peerjs = { Peer: e1, util: eM }), (window.Peer = e1);
})();
